...
项目级 memory 索引（随仓库 git 管理）。

- [semester1-repo-purpose](memory/semester1-repo-purpose.md) — 仓库用途：归档录播转写并生成每周学习笔记，靠录播自学
...
- [ee6222-course-info](memory/ee6222-course-info.md) — EE6222 Machine Vision 考核结构（期末60%+CA40%=Quiz10%Week7+Assignment×2共30%）与 Jiang Xudong/Cheng Jun 分工
